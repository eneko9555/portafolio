...
const Header = () => {
  ...
  return (
    <header
      className={`w-full m-auto md:w-10/12  justify-center  items-center p-4  pt-16 sm:px-16 z-50`}
    >
      <motion.div
      ...
      >
        <nav
          id="nav"
          className=" flex justify-between mb-16 lg:mb-0  md:flex md:justify-between  relative gap-6 sm:gap-10 items-center  "
        >
