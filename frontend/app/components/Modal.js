      ...
      >
        ...
        <div className='fixed inset-0 overflow-y-auto ' ref={modalRef}>
          <div className='flex  items-center justify-center md:p-4 text-center'>
            ...
            >
              <Dialog.Panel className='panel w-full md:max-w-2xl  transform overflow-hidden md:rounded-2xl bg-white p-2 md:p-6 text-left align-middle shadow-xl transition-all'>
                <Dialog.Title
                  as='h5'
                ...
                <div>
                  ...
                  {project.github ?
                    <>
                      ...
                      <Link
                        target='_blank'
                        href={project.github}
                        className=' font-semibold  hover:underline' rel='noreferrer'
                      >
                        {project.github}
                      </Link>
                    </>
                  ...
                  <Link
                    ...
                    href={project.website} rel='noreferrer'
                  >
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      fill='none'
